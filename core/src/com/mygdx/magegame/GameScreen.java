...
public class GameScreen implements Screen {
    ...
    public GameScreen(final MageGame game){
        ...
        debug_tool = new TextObject(world,0,0,"Text 1",false);
        debug_tool2 = new TextObject(world,0,10,"Text 2", false);
        debug_tool3 = new TextObject(world,0, -10, "Text 3", false);
        ...
        // Объект интерфейса
        place_tile = new MapTile(tileSet, world, id_of_place_tile, -window_w/2, window_h/2-tileSet.size, false);
